...
const char *ssid     = "HadiFamily";
const char *password = "Aisyaka2004";
 
WiFiUDP ntpUDP;
 
// 'time.nist.gov' is used (default server) with +7 hour offset in indonesia (28800 seconds) 60 seconds (60000 milliseconds) update interval
...
void setup() {
  ...
  lcd.init();                   // Initialize I2C LCD module (SDA = GPIO0, SCL = GPIO2)
