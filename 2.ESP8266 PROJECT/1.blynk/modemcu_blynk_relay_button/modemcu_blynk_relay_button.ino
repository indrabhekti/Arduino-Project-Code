...
#define AUTH "SL5_Bqv9HskOcnwT0oPrGFAyVn0KCofa"  // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "Kelg_Hadie"                   //Enter Wifi Name
#define WIFI_PASS "Vitri1972"                   //Enter wifi Password
