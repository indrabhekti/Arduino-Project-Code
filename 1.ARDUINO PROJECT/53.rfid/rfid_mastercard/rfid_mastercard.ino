...
//RFID RC522 Master Card untuk mendaftarkan rfid yg lain 
...
#define REDPIN 2 //led merah
#define GREENPIN 3 // led hijau
#define Relay 4 //relay

const int cardArrSize = 10;
const int cardSize    = 4;
byte cardArr[cardArrSize][cardSize];
byte masterCard[cardSize] = {9,145,3,195};   //di ganti denagan card yg ingin di gunakan sebagai master
